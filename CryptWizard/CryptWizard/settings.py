"""
Django settings for CryptWizard project.
...
SECRET_KEY = 'django-insecure-yybh9$&pz7+=lz)d1c*^tg*g&1f146rqnygxryfnkz!*!209hv'
...
WSGI_APPLICATION = 'CryptWizard.wsgi.application'
